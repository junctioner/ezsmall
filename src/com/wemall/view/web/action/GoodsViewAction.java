...
public class GoodsViewAction {
	...
	public ModelAndView goods_list(HttpServletRequest request, HttpServletResponse response, String gc_id,
			String store_id, String recommend, String currentPage, String orderBy, String orderType, String begin_price,
			String end_price) {
		...
		if (goods.getTransport() != null) {
			...
			if (goods.getTransport().getTrans_express_info() != null) {
				express_fee = this.transportTools.cal_goods_trans_fee(
						...
						CommUtil.null2String(goods.getGoods_weight()), CommUtil.null2String(goods.getGoods_volume()),
						city_name);
			}
