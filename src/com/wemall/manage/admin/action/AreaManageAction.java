...
public class AreaManageAction {
    ...
    public ModelAndView area_import(HttpServletRequest request, HttpServletResponse response, String list_url) throws Exception {
        ...
        this.databaseTools.execute("update wemall_store set area_id=null");

        this.databaseTools.execute("update wemall_address set area_id=null");

        this.databaseTools.execute("update wemall_area set parent_id=null");

        this.databaseTools.execute("delete from wemall_area");
    ...
    public ModelAndView area_export(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String tables = "wemall_accessory,wemall_adv_pos,wemall_advert,wemall_articleclass,wemall_article,wemall_document,wemall_navigation,wemall_template,wemall_sysconfig";
