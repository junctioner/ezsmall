package com.wemall.core.constant;
...
public class Globals {
    ...
    public static final String DEFAULT_TABLE_SUFFIX = "wemall_";
    public static final String THIRD_ACCOUNT_LOGIN = "wemall_thid_login_";
