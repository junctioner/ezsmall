...
public class Goods extends IdEntity {
	...
	@Column(columnDefinition = "int default 0")
	private int lookStatus;// All.所有可见,USER会员可见

	@Lob
	@Column(columnDefinition = "LongText")
	private String goods_parameter_detail;

	@Column(columnDefinition = "int default 0")
	private int effective_day;// 有效期

	private String goods_address;// 仓库所在地
	...
	public String getGoods_parameter_detail() {
		return goods_parameter_detail;
	}

	public void setGoods_parameter_detail(String goods_parameter_detail) {
		this.goods_parameter_detail = goods_parameter_detail;
	}
